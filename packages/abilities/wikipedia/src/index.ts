/**
 * `@lloyal-labs/wikipedia-ability` — HDK reference ability: Wikipedia research.
 *
 ...
 * {@link Ability}. No reranker, no config, no auth.
 *
...
/**
 * Construct the Wikipedia research ability. No configuration needed — the
 * Wikipedia public REST does not require auth.
 */
export const createWikipediaAbility = defineAbility(manifest, function* () {
